  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10">
        ...
        <p className="text-xl text-gray-700 mt-2">Find your perfect room or roommate</p>

        {loading ? (
          <p className="text-center mt-12 text-gray-700">Loading rooms...</p>
        ) : listings.length === 0 ? (
          <p className="text-center mt-12 text-gray-700">No rooms yet. Be the first to post!</p>
        ) : (
            ...
            {listings.map((room) => (
              <div key={room.id} className="bg-white rounded-3xl overflow-hidden shadow hover:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  {room.description && <p className="text-gray-700 mt-4">{room.description}</p>}
                </div>
              </div>
            ))}
          </div>
